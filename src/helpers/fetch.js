  ...
  return {
    ...
    async load() {
      const res = await fetch(
        "https://nextjs-red-six-46.vercel.app/api/wakatime/Angela0428",
        { method: "GET" }
      );
      const javascriptObject = await res.json();
      const fetchedLangeages = javascriptObject.data;
      const languagesIWant = ["JavaScript", "HTML", "Java"];
